...
function NewStoresThisMonth() {
    ...
    async function getNewStores(pageNo) {
        ...
        if (verifyObject.available) {
            const resp = await fetch(`${process.VITE_BASE_URL}/stores/newStores/${pageNo}`, {
        ...
        <div className='totoal_stores_tabel'>
            {loading ?
                ...
                : <>
                    ...
                    <h3>Total New Stores This Month: {documentCount}</h3>
...
export default NewStoresThisMonth
